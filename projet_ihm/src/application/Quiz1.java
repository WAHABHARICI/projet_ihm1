...
public class Quiz1 implements ActionListener{
	...
	String[] questions = 	{
								...
								"How does a flashlight work, and why does it need batteries?"
							};
	String[][] options = 	{
								{"Magic","Air resistance","Gravity","Magnetism"},
								{"Tiny engines inside","Friction","Acceleration","Magic wheels"},
								{"Paint in the sky","Reflection","Refraction and dispersion","Sky fairies creating colors"},
